...
```{example}
#| name: Conditional Probability 1
#| label: condprobexm1
...
```{example}
#| name: Conditional Probability 2
#| label: condprobexm2
...
```{definition}
#| name: Multiplicative Law of Probability
...
```{example}
#| name: Total Number of Occurrences
...
```{definition}
#| name: Expectation of a Discrete Random Variable
...
```{example}
#| name: Expectation of a Continuous Random Variable
#| label: expectconti
...
```{exercise}
#| name: Expectation and Variance 2
#| label: expvar2
...
```{exercise}
#| name: Expectation and Variance 3
#| label: expvar3
...
```{theorem}
#| label: clt
#| name: Central Limit Theorem (i.i.d. case)
