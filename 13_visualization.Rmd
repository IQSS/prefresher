...
Line graphs are useful for plotting time trends.  Time series data is a common form of data in social science data, and there is growing methodological work on making causal inferences with time series^[Blackwell, Matthew,  and Adam Glynn (2018). "How to Make Causal Inferences with Time-Series Cross-Sectional Data under Selection on Observables." _American Political Science Review_]. 
...
This data is adapted from the estimates of Martin and Quinn. 
