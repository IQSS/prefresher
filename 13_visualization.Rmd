...
First, the census. Read in a subset of the 2010 Census from yesterday.
...
Make a well-labelled figure that plots the proportion of the state's population (as per the census) that do not reside in a city large enough to be identified by name in the Census dataset. Each state should be labelled as a point, rather than a bar, and there should be 51 points, ordered by their size.  All labels should be readable.
