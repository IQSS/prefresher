...
```{exercise}
#| name: Plotting a mazimum and minimum
...
```{example}
#| name: Maxima and Minima by drawing
...
```{example}
#| name: Max and min with two dimensions
...
```{example}
#| name: Constrained optimization with two goods and a budget constraint
...
```{example}
#| name: Kuhn-Tucker with two variables
