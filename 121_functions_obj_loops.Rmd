...
```{r}
cen10_copy <- cen10
cen10_copy$forties <- 0
cen10_copy[cen10_copy$age > 39 & cen10_copy$age < 51, ]$forties <- 1
head(cen10_copy[cen10_copy$age > 39 & cen10_copy$age < 51, ])
``` 
