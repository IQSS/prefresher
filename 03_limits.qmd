...
```{example}
#| name: Simplifying a Fraction into Sums
Find the limit of 
...
```{exercise}
#| label: limfunmax
#| name: Limits of a Fraction of Functions
...
```{example}
#| label: contdiscont
#| name: Continuous and Discontinuous Functions
...
```{exercise}
#| label: discontdraw
#| name: Limit when Denominator converges to 0
