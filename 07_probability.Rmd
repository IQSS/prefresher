...
The Variance of a Random Variable $Y$ is
  ...
  The Standard Deviation is the square root of the variance : $\sigma= \sqrt{V(Y)}$
...
The Covariance is unfortunately hard to intepret in magnitude. The correlation is a standardized version of the covariance, and always ranges from -1 to 1. 
