...
$$P\left(a \le \sqrt{n}\frac{\bar{X}_n - \mu}{\sigma} \le b\right) \to \int_a^b \frac{1}{\sqrt{2\pi}}e^{-\frac{(x-\mu)^2}{2}} \, dx$$
...
This means that, as $n$ grows, the distribution of the mean $\bar X_n$ is approximately normal, i.e.,
