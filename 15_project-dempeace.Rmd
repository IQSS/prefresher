# Joins and Merges, Wide and Long^[Module originally written by Shiro Kuriwaki and Yon Soo Park]{#dempeace}
...
p_m %>% 
  group_by(dispute) %>% 
  summarize(mean_polity = mean(polity2, na.rm =))
```
...
3. Arrive at a tentative conclusion for how well the Democratic Peace argument seems to hold up in this dataset. Visualize this conclusion. 
