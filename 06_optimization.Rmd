...
So  $f(x)=x^2+2$, $f^\prime(x)=2x$

`r include_graphics("images/deriv1-eps-converted-to.pdf")`


And $f(x)=x^3+2$, $f^prime(x)=3x^2$

`r include_graphics("images/deriv2-eps-converted-to.pdf")`
