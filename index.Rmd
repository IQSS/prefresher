...
This booklet serves as the text for the Prefresher, available as a [webpage](https://iqss.github.io/prefresher/) and as a [printable PDF](https://github.com/IQSS/prefresher/releases). It is the product of generations of Prefresher instructors. See below for a full list of instructors and contributors. 
