...
# Data Import (and Orientation)^[Module originally written by Shiro Kuriwaki] {#dataimport}
...
* In the RStudio Pane, what is the difference between the "Source" Pane and the "Console"? What is a "code chunk"?
...
We'll do the Peanut Butter and Jelly Exercise in Class as an introduction to programming for those who are new.^[This Exercise taken from Harvard's Introductory Undergraduate Class, CS50 (<https://www.youtube.com/watch?v=kcbT3hrEi9s>), and many other writeups.]
...
* `input/acs2016_1percent.csv`: A one percent sample of the American Community Survey
