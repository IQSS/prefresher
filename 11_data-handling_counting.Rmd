...
(A R Instructor's headache?)

Many things in R and other open source packages have competing standards. A lecture on a technique inevitably biases one standard over another. Right now among R users in this , there are two families of functions  We try our best to choose the one that is most relevant and useful, but feel free to suggest changes to us or to the booklet. 


| To ...        | in tidyverse: | in base-R:  |
|---------------|:--------------|:------------|
